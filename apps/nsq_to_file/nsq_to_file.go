...
var (
	...
	lengthPrefix   = flag.Bool("length-prefix", false, "Write a 4-byte big endian length prefix before each message. Useful for binary message formats. If true, disables newline message delimiters")
